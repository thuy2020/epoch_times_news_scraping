...
mainword <- wordcloud(words = df_freq$word,
          freq = df_freq$freq,
          min.freq = 250,
          random.order = FALSE,
          colors = brewer.pal(6, "Dark2"))
ggsave("output/mainword.png", mainword, width = 6, height = 4, dpi = 300)
...
ggsave("output/sentiment.png", sentiment, width = 6, height = 4, dpi = 300)
```

...
# need to make sure all the links are clean, 

# random checking reveals that some links are not clean. Fore example: 
somelinks <- all_article_links[1000:1003]

#using rebus 
library(rebus)
pattern <- START %R% "<a" %R% ANY_CHAR %R% END

clean_links <- str_view_all(somelinks, pattern = START %R% "<a" %R% ANY_CHAR %R% END)


subset(somelinks, clean_links)

...
TermDocumentMatrix(test_corpus)
# create a volatile corpus
test_corpus <- VCorpus(VectorSource(test5_unlist))
...
dim(test_m) # # 5 articles, 6 features, why length of 25? --> some features are NA. Eg. the 1st articles has 4, the second 5, the third 6, 

test_m[c("trump", "biden"), 10:15]

my_stopwords <- c("president", stopwords("en"))

test_clean <- tm_map(test_corpus, removeWords, my_stopwords)

content(test_corpus[[10]])
